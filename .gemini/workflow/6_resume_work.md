...
Read session summary if provided:
...
Session summary - Understand where we left off
Implementation plan - See overall progress
Research document - Refresh technical context
Recent commits - Review completed work
# Check current state
git status
git log --oneline -10
...
Review changes to related files
Update plan if needed
Communicate impacts to user
Session Comparison
...
A successful resume should:
 ...
 Preserve all previous decisionsResume Work
You are tasked with resuming previously saved work by restoring full context and continuing implementation.
